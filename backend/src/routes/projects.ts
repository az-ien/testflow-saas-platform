...
router.patch('/:id',
  [
    ...
    body('jiraBaseUrl').optional({ checkFalsy: true }).isURL(),
    body('jiraProjectKey').optional().trim(),
    body('jiraEmail').optional().isEmail(),
    body('jiraApiToken').optional().trim(),
    body('aiProvider').optional().isIn(['heuristic', 'openai', 'anthropic']),
    body('openaiApiKey').optional().trim(),
